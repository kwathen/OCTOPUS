...
# ViPER - Virtual Platform Evaluator in R   <img src="man/figures/logo.png" align="right" alt="" width="120" />
...
## Installation 
Currently this package is not available on CRAN but may be installed directly from the tar.gz files located in GitHub.  The most recent version is [Version 1.2.1.2](https://github.com/kwathen/PlatformTrialSimulator/blob/master/PlatformTrialSimulator_1.2.1.2.tar.gz).   If you have the  PlatformTrialSimulator_1.2.1.2.tar.gz in the current working directory the following command will install the package.
