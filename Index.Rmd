...
## Installation 
Currently this package is not available on CRAN but may be installed directly from 1) GitHub or 2) a tar.gz files located in GitHub.  The most recent version is [Version 1.3.0.5](https://github.com/kwathen/OCTOPUS/releases/tag/Version1.3.0.5).   
