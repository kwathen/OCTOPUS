...
# OCTOPUS - Optimize Clinical Trials On Platforms Using Simulation   <img src="man/figures/logo.png" align="right" alt="" width="120" />
...
```{r, eval = FALSE}
install.packages("PlatformTrialSimulator_1.3.0.3.tar.gz", repos=NULL)
````
