...
## This funciton is not needed as the borrow of patients is at an ISA level not the trial level - this was from a previous verison

#' #' @export
#' RunTrialAnalysis.IncludeAllControl <- function( cISADesigns, cEnrolledPats,  vISAStatus, dCurrentTime,  vRunISAAnalysis, vISAAnalysisIndx, vIsFinalISAAnalysis  )
#' {
...
#'
#'             ###########################
#'             #####  TODO(Kyle) - This use to have vIsFinalISA which has been replaced by index but may not do all that is necessary steps
#'
