...
Please follow or star this project to be notified of updates.  
...
It is useful to understand the [flow of a simulation](SimulationTrialOutline.html) as well as the [key simulation objcts](PrimaryObjectsForSimulation.html)
