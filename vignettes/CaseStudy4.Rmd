...
This case study (CS) builds on [Case Study 3](https://kwathen.github.io/PlatformTrialSimulator/articles/CaseStudy3.html) by adding a second ISA and introduces the concept of simulating the enrty type of ISA 2.  For simplicity, the case study assume both ISAs have 2 treatment ( control vs treatment ) and assume the same treatment effect for both experimental arms.  
